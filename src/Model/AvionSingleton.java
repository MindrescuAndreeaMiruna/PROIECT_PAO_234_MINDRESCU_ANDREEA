...
public class AvionSingleton {
    ...
    public void getCSV(){
        ...
        for(String[] campuri : coloane){
            Avion avionNou = new Avion(Integer.parseInt(campuri[0]), Integer.parseInt(campuri[1]), campuri[2], Integer.parseInt(campuri[3]), Integer.parseInt(campuri[4]), campuri[5], campuri[6], Integer.parseInt(campuri[7]));
